package org.java8.effectiveJava.functionalProgramming.streams.ch10;
...
public class FootballTeamTest {
    ...
    public static Map<League, Integer> totalGoalsInEachLeague(List<FootballTeam> data) {
        data.stream().collect(Collectors.groupingBy(FootballTeam::getLeague, Collectors.summingLong(FootballTeam::getGoalsFor)));
        return data.stream()
                .collect(Collectors.groupingBy
                        (
                                FootballTeam::getLeague,
    ...
    public static Map<Boolean, List<FootballTeam>> partitionByCL(List<FootballTeam> data) {
        Map<Boolean, List<FootballTeam>> map = data.stream().collect(Collectors.partitioningBy(x -> x.equals(League.PREMIER_LEAGUE)));
        return data.stream()
    ...
    public static Map<Boolean, Map<League, List<FootballTeam>>> multiLevelPartCL(List<FootballTeam> data) {
        data.stream().
                collect(Collectors.partitioningBy(team -> isTeamInChampionsLeague(team), Collectors.groupingBy(FootballTeam::getLeague)));
        return data.stream()
